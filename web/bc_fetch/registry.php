...
require_once __DIR__ . '/column_project_finance.php';
require_once __DIR__ . '/column_workorder_finance.php';
...
function bc_fetch_column_registry(): array
{
    return [
        ...
        'project_finance' => [
            ...
            'function' => 'bc_fetch_column_project_finance',
        ],
        'workorder_finance' => [
            'label' => 'Werkorder Finance',
            'function' => 'bc_fetch_column_workorder_finance',
        ],
        'project_details' => [
